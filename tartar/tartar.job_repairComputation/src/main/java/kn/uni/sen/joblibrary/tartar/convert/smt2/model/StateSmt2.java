...
public class StateSmt2
{
	...
	List<String> uppaalIDList = new ArrayList<>();
	...
	public boolean contains(VariableSmt2 uv)
	{
		return variableList.contains(uv);
	}
	...
	public void addUppaalID(String id)
	{
		uppaalIDList.add(id);
	}

	public List<String> getUppaalID()
	{
		return uppaalIDList;
	}
