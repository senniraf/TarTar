...
import kn.uni.sen.tartar.uppaal2smt2.uppaalmodel.model.ConstantModel;
import kn.uni.sen.tartar.uppaal2smt2.uppaalmodel.model.ConstraintInterface;
import kn.uni.sen.tartar.uppaal2smt2.uppaalmodel.model.ConstraintModel;
...
import kn.uni.sen.tartar.uppaal2smt2.uppaalmodel.model.TemplateModel;
import kn.uni.sen.tartar.uppaal2smt2.uppaalmodel.model.VariableModel;
import kn.uni.sen.tartar.uppaal2smt2.uppaaltrace.model.Edge;
import kn.uni.sen.tartar.uppaal2smt2.uppaaltrace.model.LocationVector;
import kn.uni.sen.tartar.uppaal2smt2.uppaaltrace.model.Node;
import kn.uni.sen.tartar.uppaal2smt2.uppaaltrace.model.Trace;
import kn.uni.sen.tartar.uppaal2smt2.uppaaltrace.model.Transition;
import kn.uni.sen.tartar.uppaal2smt2.uppaaltrace.model.VariableState;
...
public class Trace2Smt2ByModel extends Trace2Smt2ByBDM
{
	...
	StateSmt2 convertState(Node node, Transition trans, int zoneCounter)
	{
		...
		for (String locName : locVec.getLocationList())
		{
			...
			stateSmt2.addUppaalID(loc.getIDModel());
		}
	...
	public ModelSmt2 transform(Trace trace, Model model, int commentDepth)
	{
		this.model = model;
		if (this.model == null)
		{
		...
		ModelSmt2 smt2 = super.transform(trace, model, commentDepth);
