...
public class Smt22TextImply extends Smt22Text
{
	...
	public Smt22TextImply(boolean command, ConstraintSmt2 property)
	{
		super(false, command);
	...
	public String transform(ModelSmt2 smt2, int commentDepth)
	{
		...
		Smt22TextForall convert = new Smt22TextForall();
		text += convert.transform(smt2, commentDepth);
