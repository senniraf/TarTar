...
public class Smt22Text extends Transformer
{
	...
	public Smt22Text(boolean bdm, boolean command)
	{
		substitute = false;
	...
	/*protected String getPositiveClockList(List<ClockSmt2> clockList)
	{
		String text = comment(1, "; clocks are always positive\n");
		int index = 2;
		for (ClockSmt2 clock : clockList)
		{
